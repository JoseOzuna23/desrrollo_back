...
import com.coop8.demojwt.Service.TiposDocumentosService;
...
@RestController
@RequestMapping("/referenciales/tiposDocumentos")
@Slf4j
public class TiposDocumentosController {
	String BaseUrlEndPoint;

	public TiposDocumentosController() {
		BaseUrlEndPoint = "/referenciales/tiposDocumentos";
	...
	public ResponseEntity<?> list(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(tiposDocumentosService.list(requestData), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> edit(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(tiposDocumentosService.getById(requestData), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> newAction(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(tiposDocumentosService.save(requestData), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteById(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(tiposDocumentosService.deleteById(requestData), HttpStatus.OK);
	}
}