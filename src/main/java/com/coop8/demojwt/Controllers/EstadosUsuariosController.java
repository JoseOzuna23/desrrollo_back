...
import com.coop8.demojwt.Service.EstadosUsuariosService;
...
@RestController
@RequestMapping("/referenciales/estadosUsuarios")
@Slf4j
public class EstadosUsuariosController {
	String BaseUrlEndPoint;

	public EstadosUsuariosController() {
		BaseUrlEndPoint = "/referenciales/estadosUsuarios";
		log.info("__BASE_end_point:	" + BaseUrlEndPoint);
	}

	@Autowired
	EstadosUsuariosService estadosUsuariosService;
	...
	public ResponseEntity<?> list(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(estadosUsuariosService.list(requestData), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> edit(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(estadosUsuariosService.getById(requestData), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> newAction(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(estadosUsuariosService.save(requestData), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteById(@Valid @RequestBody RequestData requestData) throws Exception {
		...
		return new ResponseEntity<>(estadosUsuariosService.deleteById(requestData), HttpStatus.OK);
	}
}